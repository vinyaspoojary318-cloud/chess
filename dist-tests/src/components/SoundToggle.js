...
export function SoundToggle() {
    ...
    return (_jsx("button", { className: "sound-toggle-btn", onClick: toggleMute, title: isMuted ? 'Unmute sounds' : 'Mute sounds', "aria-label": isMuted ? 'Unmute sounds' : 'Mute sounds', children: isMuted ? (_jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("polygon", { points: "11 5 6 9 2 9 2 15 6 15 11 19 11 5" }), _jsx("line", { x1: "23", y1: "9", x2: "17", y2: "15" }), _jsx("line", { x1: "17", y1: "9", x2: "23", y2: "15" })] })) : (_jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("polygon", { points: "11 5 6 9 2 9 2 15 6 15 11 19 11 5" }), _jsx("path", { d: "M19.07 4.93a10 10 0 0 1 0 14.14" }), _jsx("path", { d: "M15.54 8.46a5 5 0 0 1 0 7.07" })] })) }));
}
