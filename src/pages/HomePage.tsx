...
export function HomePage() {
  ...
  const [mode, setMode] = useState<'pgn' | 'manual' | 'play' | 'play-computer'>('play-computer');
  ...
  return (
    <div className="home-page">
      ...
      <div className="mode-tabs">
        ...
        <button
          className={`mode-tab ${mode === 'play-computer' ? 'active' : ''}`}
      ...
      <div className="upload-card">
        {mode === 'play-computer' ? (
          <div style={{ textAlign: 'center', padding: '2rem' }}>
            ...
            <p style={{ marginBottom: '2rem' }}>Challenge the Stockfish engine directly in your browser.</p>
            <button 
